...
export function WorkTimeline() {
  const data = [
    {
      title: "Core Team Google DGOC Unesa",
      time: "2024 - 2025",
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            ...
            decorations for every Google Developer Group on Campus Unesa&apos;s
            event.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/images/medcre.png"
    ...
    {
      title: "Mern Stack Bootcamp WPU Course",
      time: "2025",
      content: (
        <div>
          <p className="mb-8 text-xs font-normal text-neutral-800 md:text-sm dark:text-neutral-200">
            ...
            frontend, all the way to deployment on Vercel using the MERN Tech
            Stack.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/assets/acara1.png"
              alt="startup template"
              width={500}
              height={500}
              className="h-20 w-full rounded-lg object-cover shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset] md:h-44 lg:h-60"
